...
export default function Home() {
  ...
  return (
    <div>
      ...
      <p><img className="blog" alt='blog' src='https://contents.mediadecathlon.com/s1071034/k$1cd72b462393e23fa1d84d03feb2c3c1/defaut.jpg?format=auto&f=969x0' height='30px' /><span className="font">READ OUR SPORTY STORIES</span></p>
      <Container >
        <Row className="g-4">
            {blogs.map((emp,index) => (
