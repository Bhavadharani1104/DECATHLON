...
export default function OurCollection() {
  return (
    <div>
        <Container>
        <p>
        <span className='span'><h4>Our Sport Collections :</h4></span>
        <br />
        <span className='spn'>
          Badminton : Badminton Racket | Shuttle cock | Badminton shoes | Non Marking shoes | Badminton Tshirts | Badminton shorts | Racket cover | Badminton grip | Badminton net | Racket string |
          <br />
          Tennis : Tennis Clothing | Men Socks | Tennis Rackets |  | Tennis Shoes | Tennis bag | Tennis Accessories | Beach tennis | Men Tennis apparels | Women Tennis Apparels |<br />
          ...
          Hiking : Fleece | Sweaters | Rain Jacket | Hiking shoes |  | Men Socks | Backpack | Hiking Backpack |  | Bottles |<br />
          ...
          Skiing : Men Thermals | Women Thermals | Beanies |  | Winter Accessories | Warmers | Junior Jackets | Junior Beanies | Ski jackets |<br />
          Wildlife : Camo Tshirts | Camo Trousers | Camo Bermudas | Camo Caps | Gum Boots | Binoculars |  | Shelter | Umbrellas | Pouches |<br />
          Cycle : Bike Racks | Cycles | Mountain Cycles | Hybrid Cycles | Road Bikes | Kids Cycle | Cycle Accessories |<br />
          ...
          Surfing : Board shorts | Frisbee | shorts2 | Wetsuits | Bodyboards | Kites | Snorkelling | Scuba diving | Kayaks | Standup paddle |<br />
          Running :  | Jogging shoes |  | Running Tshirts | Running shorts | Running Tights |  | Sports watch | Weighing scale | Earphones |<br />
          ...
          About us : Now enjoy and experience the entire offering of Decathlon India’s 60+ sports and over 6000+ products by using the Decathlon mobile application! |<br />
          ...
          Men Winter Collections : Men Sweaters | Men Fleece Jacket |  | Men Sweatshirt | Men Hoodies | Men Winter Coat |  | Men Puffer Jacket | Men Down Jacket | Men Snow Jacket | Men Bomber Jacket | Winter Shoes | Men Winter Shoes | Snow Socks | Men Winter Outfits | Men Winter Tshirt | Men Thermals | Men Warm Trouser |<br />
          Women Winter Collection : Women Sweaters | Women Fleece Jacket | Women Pullover | Women Sweatshirt | Women Jackets | Women Winter Jacket | Women Puffer Jacket | Women Down Jacket | Women Snow Jacket | Women Bomber Jacket | Women Snow Shoes | Women Winter Outfits | Women Thermals | Women Warm Trouser |<br /></span>
      </p>
    </Container>
  );
